...
export default function Contact({ locale }: ContactProps) {
  ...
  const t = useMemo(() => ({
    label: isRtl ? "بیایید صحبت کنیم" : "Let's talk",
    title: isRtl ? "شروع یک گفت‌وگو" : "Start a conversation",
    sub: isRtl ? "ایده‌ای دارید یا می‌خواهید درباره یک همکاری صحبت کنیم؟ خوشحال می‌شوم بشنوم." : "Have an idea or want to explore a collaboration? I'd love to hear from you.",
    h3: isRtl ? "از کاری که روی آن هستید بگویید" : "Tell me what you're working on",
    p: isRtl ? "پروژه، سؤال یا حتی یک سلام؛ صندوق ورودی من برای گفت‌وگوهای تازه باز است." : "A project, a question, or even a simple hello — my inbox is open to a good conversation.",
    email: isRtl ? "ایمیل" : "Email",
    name: isRtl ? "نام" : "Name",
    namePh: isRtl ? "نام شما" : "How should I address you?",
    emailPh: "your@email.com",
    msg: isRtl ? "چطور می‌توانم کمک کنم؟" : "How can I help?",
    msgPh: isRtl ? "کمی درباره ایده یا نیازتان بنویسید..." : "Tell me a little about your idea or need...",
    send: isRtl ? "ارسال پیام" : "Send message",
    sending: isRtl ? "در حال ارسال..." : "Sending...",
    successMsg: isRtl ? "ممنون؛ پیامتان ارسال شد. به‌زودی پاسخ می‌دهم." : "Thanks — your message is on its way. I'll get back to you soon.",
    errorMsg: isRtl ? "فعلاً امکان ارسال پیام نبود. لطفاً دوباره تلاش کنید." : "I couldn't send that right now. Please try again.",
    rateLimitMsg: isRtl ? "تلاش‌های زیادی انجام شده است. لطفاً کمی بعد دوباره امتحان کنید." : "There have been too many attempts. Please try again in a little while.",
    nameReq: isRtl ? "نام باید دست‌کم ۲ حرف داشته باشد." : "Please enter at least 2 characters for your name.",
    emailReq: isRtl ? "لطفاً یک ایمیل معتبر وارد کنید." : "Please enter a valid email address.",
    msgReq: isRtl ? "پیامتان باید دست‌کم ۱۰ حرف داشته باشد." : "Please write at least 10 characters.",
    rateReq: isRtl ? "لطفاً امتیازتان را انتخاب کنید." : "Please choose a rating.",
  }), [isRtl])
